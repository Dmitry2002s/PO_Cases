...
Скрипт на Python (pandas, openpyxl) выгружает задачи в плоский список, все заинтересованные лица видят единую плоскую таблицу. 
...
| **Корректировка во время квартала (поиск «донора»)** | ~3 человеко-часа – нужно узнать актуальность приоритетов каждой задачи вручную | 5 минут – РП видит готовые варианты (отсортированный список низкоприоритетных задач) и принимает решение | ~3 чд/мес |
